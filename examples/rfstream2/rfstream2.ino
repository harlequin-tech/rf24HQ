/*
 * rfstream2.ino rf24HQ stream demo.
 *
 ...
 *
 * Run rfstream1.ino on the partner radio to connect to this sketch.
 *
...
const char myAddress[] = "rad02";			/* The rx address for this radio */
const char txAddress[] = "rad01";			/* Send data to this address */
